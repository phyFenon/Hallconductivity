Program energyband
use omp_lib ! this is for parallelisation on several cores
Implicit None
Integer, Parameter :: width=100,n=2*width,nEpsilon=200,stepsx=1,stepsz=1001! width->the landau levels   
...
Open (10, File='hall_m=1_t0=0.0_Bz4.txt')
